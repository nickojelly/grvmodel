...
if __name__ == '__main__':
    ...
    # model_name = 'decent-deluge-528'
    # model_name = 'trim-disco-532'
    model_name = 'tough-snow-10'
    ...
    outs_1.to_pickle(f'//root/grv_model/flumine_betting/inputs/output {today_date}.npy')
