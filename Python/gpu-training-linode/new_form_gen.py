...
def get_fasttrack_data():
    ...
    fasttrack_df['tab_track'] = fasttrack_df.tab_track.apply(lambda x: TRACK_RENAME[x] if x in TRACK_RENAME.keys() else x)
...
if __name__ == "__main__":
    ...
    new_form = merged[merged['Box']<=8][['Track','State','DogId','DogName','DogGrade', 'RaceId','Distance', 'Date', 'Box','race_time','RaceNum']].rename(columns={ 'RaceNum':'race_num'})
