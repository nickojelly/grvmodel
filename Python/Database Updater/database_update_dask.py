...
if __name__ == "__main__":
    # # Standard locations
    # generate_mode = input("Enter run mode:")
    ...
    # prev_gru_df = pd.read_pickle(r"C:\Users\Nick\Documents\GitHub\grvmodel\Python\DATA\new_windows_gru_REAL.npy")
    ...
    x = featurecreations_dask.generate_results_df_v2(prev_full_details, dog_results, 'na', betfair_sp_file, split_dist_file,mode="OO", prev_df="AHHHH", ohe='encoder')

    print(x)
    x.to_pickle(r"C:\Users\Nick\Documents\GitHub\grvmodel\Python\DATA\new_windows_gru_REAL.npy")
