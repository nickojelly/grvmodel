...
def setup_data():
    ...
    bfSP = torch.Tensor(torch.Tensor(np.array([i[4] for i in training_data])))
...
if __name__=='__main__':
    ...
    normal_config = {'batch_size': 32, 'dropout': 0.3, 'epochs': 5000, 'f1_layer_size': 64, 'f2_layer_size': 64, 'learning_rate': 0.00047085841644517234, 'loss': 'L1', 'num_layers': 3, 'optimizer': 'adam', 'validation_split': 0.1}
