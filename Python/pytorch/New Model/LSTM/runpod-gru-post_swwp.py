...
def model_pipeline(my_dataset=None,config=None,prev_model=None, sweep=True, model_state_dict=None, prev_model_file=None, prev_model_version='450'):
        ...
        with wandb.init(project="runpod-gpu", config=config):
            ...
            wandb.define_metric("val_multibet profit < 30", summary="max")
            config = wandb.config
...
if __name__=="__main__":
        ...
        metric = {"name": "val_multibet profit < 30.max", "goal": "maximize"}
        ...
        parameters_dict = {
            ...
            'split_speed_avg_1': {'values': [0]},
            'split_margin_avg_1': {'values': [0]},
            'margin_avg_1': {'values': [0]},
            'margin_time_avg_1': {'values': [0, 1]},
            'RunHomeTime_1': {'values': [0]},
        ...
        wandb.agent('pmhfk3rb', function=model_pipeline, count=100,project="Variable Sweeps")
