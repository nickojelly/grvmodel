...
def update_results_data():
    ...
    lastweek = (datetime.today()-timedelta(days=10)).strftime('%Y-%m-%d')
...
if __name__ == "__main__":
    ...
    x,stats_cols = featurecreations.generate_results_df_v2(prev_full_details, dog_results, 'na', betfair_sp_file, split_dist_file,mode="OO", prev_df="AHHHHH", ohe='encoder_new', simple=simple, normalize=normalize, v6=v6)
    ...
    x.to_feather(f"./DATA/gru_inputs_new{simp}{norm}{v6ed}_test.fth")

    print(f"./DATA/gru_inputs_new{simp}{norm}{v6ed}_test.fth")
