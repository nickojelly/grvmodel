...
if __name__ == "__main__":
    ...
    betfair_sp_file = 'df-betfairSP_new.fth'
    ...
    x,stats_cols = featurecreations_polars.generate_results_df_v2(prev_full_details, dog_results, 'na', betfair_sp_file, split_dist_file,mode="OO", prev_df="AHHHHH", ohe='encoder_new', simple=simple, normalize=normalize,v6=False)
